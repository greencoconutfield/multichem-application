package com.yukam.mypam.web.filter.gzip;
...
public final class GZipResponseUtil {
     ...
     * @throws com.yukam.mypam.web.filter.gzip.GzipResponseHeadersNotModifiableException Either the response is committed or we were called using the include method
