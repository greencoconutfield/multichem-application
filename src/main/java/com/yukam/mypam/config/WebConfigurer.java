package com.yukam.mypam.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import com.yukam.mypam.web.filter.CachingHttpHeadersFilter;
import com.yukam.mypam.web.filter.StaticResourcesProductionFilter;
import com.yukam.mypam.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        if (env.acceptsProfiles(Constants.SPRING_PROFILE_PRODUCTION)) {
            ...
            log.info("Web application fully configured with production");
        }
